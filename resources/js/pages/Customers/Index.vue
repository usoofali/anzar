...
import { MoreHorizontal, Pencil, Plus, Search, Store, Trash2 } from '@lucide/vue';
                                    ...
                                    <td class="px-4 py-3 text-right whitespace-nowrap">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end" class="w-44">
                                                ...
                                                <DropdownMenuItem @select="openEditModal(c)" class="flex items-center gap-2 cursor-pointer text-xs">
                                                    <Pencil class="h-4 w-4 text-blue-500" />
                                                    <span>Edit Customer</span>
                                                </DropdownMenuItem>
                                                <DropdownMenuSeparator />
                                                <DropdownMenuItem @select="openDeleteModal(c)" class="flex items-center gap-2 cursor-pointer text-xs text-rose-600 dark:text-rose-400 focus:text-rose-600 focus:bg-rose-50 dark:focus:bg-rose-950/50">
